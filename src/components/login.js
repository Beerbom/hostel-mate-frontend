...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (AdmNo === "admin" && password === "admin123") {
        ...
        const response = await axios.post('/api/login', { AdmNo, password });
  ...
  return (
    <div className='d-flex justify-content-center '>
      <div className='py-8 px-4 shadow rounded-lg   px-10 w-100 mt-10 rounded ' style={{ backgroundColor: "#2E2E2E", maxWidth: "500px",minHeight:"380px", marginTop: "50px", maxHeight: "1800px" }}>
